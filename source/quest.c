...
char *quest_name[64] = {
	...
	"NOT_YET", "NOT_YET", "NOT_YET", "NOT_YET", "NOT_YET",	/* 5 - 9 */
...
int is_solved_quest(charType *ch, int quest)
{
	int mask ;
...
int set_solved_quest(charType *ch, int quest)
{
	int mask ;
	/*  it assume, integer size is 4 byte(32 bit)  */
   if ( quest >= 64 || quest < 0 )
...
int clear_solved_quest(charType *ch, int quest)
{
	int mask ;
	/*  it assume, integer size is 4 byte(32 bit)  */
   if ( quest >= 64 || quest < 0 )
...
char *what_is_solved(charType *ch)
{
...
void clear_all_quest(charType *ch)
{
	int i ;
