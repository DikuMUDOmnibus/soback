...
#define GET_POS(ch)     ((int)(ch)->position)
#define GET_COND(ch, i) ((int)(ch)->conditions[(i)])
#define GET_NAME(ch)    ((ch)->name)
#define GET_TITLE(ch)   ((ch)->title)
#define GET_LEVEL(ch)   ((int)(ch)->level)
#define GET_CLASS(ch)   ((int)(ch)->class)
#define GET_AGE(ch)     ((int)age(ch).year)
#define GET_STR(ch)     ((int)(ch)->temp_stat.str)
#define GET_ADD(ch)     ((int)(ch)->temp_stat.str_add)
#define GET_DEX(ch)     ((int)(ch)->temp_stat.dex)
#define GET_INT(ch)     ((int)(ch)->temp_stat.intel)
#define GET_WIS(ch)     ((int)(ch)->temp_stat.wis)
#define GET_CON(ch)     ((int)(ch)->temp_stat.con)
#define GET_AC(ch)      ((int)(ch)->armor)
#define GET_HIT(ch)     ((int)(ch)->hit)
#define GET_MAX_HIT(ch) ((int)hit_limit(ch))
#define GET_MOVE(ch)    ((int)(ch)->move)
#define GET_MAX_MOVE(ch)((int)move_limit(ch))
#define GET_MANA(ch)    ((int)(ch)->mana)
#define GET_MAX_MANA(ch)((int)mana_limit(ch))
#define GET_GOLD(ch)    ((int)(ch)->gold)
#define GET_EXP(ch)     ((int)(ch)->exp)
#define GET_ALIGN(ch) 	((int)(ch)->align)
#define GET_HEIGHT(ch)  ((int)(ch)->height)
#define GET_WEIGHT(ch)  ((int)(ch)->weight)
#define GET_SEX(ch)     ((int)(ch)->sex)
#define GET_HITROLL(ch) ((int)(ch)->hr)
#define GET_DAMROLL(ch) ((int)(ch)->dr)
#define GET_REGEN(ch) 	((int)(ch)->regen)
